...
{
	const line = document.querySelectorAll('[data-cart-product-id~=${lineID}]');
...
function submitHandler(event)
{
	...
	const lineId = Number.parseInt(parent.dataset.productCartId);
...
export function createCartLine(product, quantity) {
  ...
  */
  ...
  cartLineElement.dataset.cartProductId = product.id;
